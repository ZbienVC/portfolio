...
const PROJECTS = [
  ...
  },
  {
    ...
    highlights: ['Five Solidity contracts, ~500 tests green', 'Reorg-tolerant chain indexer and WebSocket API', 'Emergent agent-to-agent supply chains', 'Live testnet economy, free to watch'],
  },
  {
    id: 'wakerush',
    name: 'Wake Rush',
...
const LIFE_PHOTOS = [
  ...
  { src: '/life/photo10.jpg', label: 'Barcelona' },
  { src: '/life/photo11.jpg', label: 'Underground' },
];
