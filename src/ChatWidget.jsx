    ...
    <>
      <style>{`
        ...
        @keyframes chatPulse {
          ...
          50% { box-shadow: 0 0 0 12px rgba(16,217,160,0); }
        }
        ...
        .chat-msg-user { background: linear-gradient(135deg, #10d9a0, #059669); color: #fff; border-radius: 18px 18px 4px 18px; }
        ...
        .chat-input:focus { outline: none; border-color: rgba(16,217,160,0.5) !important; }
        .chat-send:hover { background: rgba(16,217,160,0.25) !important; }
        .chat-suggest:hover { background: rgba(16,217,160,0.15) !important; border-color: rgba(16,217,160,0.4) !important; }
      `}</style>
      ...
      <button onClick={() => setOpen(o => !o)}
        style={{
          ...
          background: open ? 'rgba(20,30,50,0.95)' : 'linear-gradient(135deg, #10d9a0, #059669)',
          border: open ? '1px solid rgba(16,217,160,0.3)' : 'none',
          color: '#fff', cursor: 'pointer',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          boxShadow: open ? '0 4px 20px rgba(0,0,0,0.4)' : '0 4px 24px rgba(16,217,160,0.4)',
      ...
      {!open && pulse && (
        <div style={{
          ...
          background: '#10d9a0', border: '2px solid #040810',
        }} />
      )}
      ...
      {open && (
        <div className="chat-widget-enter" style={{
          ...
          borderRadius: 20,
          boxShadow: '0 24px 64px rgba(0,0,0,0.6), 0 0 0 1px rgba(16,217,160,0.08)',
          zIndex: 9998,
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: 'linear-gradient(135deg, #10d9a0, #4f9deb)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 16, flexShrink: 0,
            }}>ZB</div>
            <div>
              <div style={{ fontWeight: 700, fontSize: 14, color: '#f0f4ff' }}>Zach's AI</div>
              <div style={{ fontSize: 11, color: '#10d9a0', display: 'flex', alignItems: 'center', gap: 5 }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#10d9a0', display: 'inline-block' }} />
                Online now
              </div>
            </div>
            <button onClick={() => setShowContact(s => !s)}
              style={{
                ...
                color: '#10d9a0', fontSize: 11, fontWeight: 700, cursor: 'pointer',
                transition: 'all 0.2s',
              }}>
            ...
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 12, flex: 1, overflowY: 'auto' }}>
              {sent ? (
                <div style={{ textAlign: 'center', padding: '32px 0' }}>
                  ...
                  <div style={{ fontWeight: 700, fontSize: 15, color: '#10d9a0', marginBottom: 8 }}>Message sent!</div>
                ...
                <>
                  ...
                  <button onClick={sendContact}
                    ...
                    style={{
                      ...
                      color: contact.name && contact.message ? '#fff' : '#4a5580',
              ...
              <div style={{
                ...
                <button onClick={() => sendMessage()} disabled={!input.trim() || loading}
                  ...
                  style={{
                    ...
                    background: input.trim() && !loading ? 'rgba(16,217,160,0.15)' : 'rgba(255,255,255,0.04)',
                    color: input.trim() && !loading ? '#10d9a0' : '#4a5580',
